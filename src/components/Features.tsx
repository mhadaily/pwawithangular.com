...
const FeatureSvgBg = () => (
  <svg viewBox="0 0 276.1 281.01" className="shape shape-xxl drop-shadow">
    <linearGradient id="linear-gradient-feature" y1="140.5" x2="276.1" y2="140.5" gradientUnits="userSpaceOnUse">
      <stop offset="0" stopColor="var(--purpleLogoLeft)" />
      <stop offset="1" stopColor="var(--purpleLogoRight)" />
    </linearGradient>
    <path
      ...
      fill="url(#linear-gradient-feature)"
      opacity={0.8}
    />
  </svg>
);
